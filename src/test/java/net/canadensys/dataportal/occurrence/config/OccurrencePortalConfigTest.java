...
public class OccurrencePortalConfigTest {
	...
	public void testConfigLoading() {
		...
		assertEquals(
				"cc0",
				occurrencePortalConfig
						.getLicenseShortName("http://creativecommons.org/publicdomain/zero/1.0/"));
	}

	@Test
	public void testGetDownloadEmailTemplateName() {
		assertEquals("download-email_en.ftl",
				occurrencePortalConfig
						.getDownloadEmailTemplateName(Locale.ENGLISH));
	}
