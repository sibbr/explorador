...
public class TestDataHelper {
	 ...
	 * @param template
	 */
	public static void loadTestData(ApplicationContext appContext,
			JdbcTemplate jdbcTemplate) {
		Resource testDataScript = appContext
				.getResource(TEST_DATA_SCRIPT_LOCATION);

		try {
			JdbcTestUtils.deleteFromTables(jdbcTemplate, "occurrence",
					"occurrence_raw", "occurrence_extension");
