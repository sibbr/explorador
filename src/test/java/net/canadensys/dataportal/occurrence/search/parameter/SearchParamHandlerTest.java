...
public class SearchParamHandlerTest {
	...
	public void testSearchParamHandler() {
		...
		Collection<SearchQueryPart> sqpColl = paramHandler
				.getSearchQueryPartCollection(parametersMap);
	...
	public void testSearchParamHandlerSortPath() {
		...
		SearchSortPart sortPart = paramHandler
				.getSearchQuerySort(parametersMap);
	...
	public void testGetSearchQueryRelatedParameters() {
		...
		Map<String, String> queryRelatedParams = paramHandler
				.getSearchQueryRelatedParameters(parametersMap);
	...
	public void testEmptyParams() {
		...
		Collection<SearchQueryPart> queryRelatedParams = paramHandler
				.getSearchQueryPartCollection(parametersMap);
