...
/**
 * Very simple and basic Integration test to make sure we can rendered some
 * pages.
 * 
 * @author canadensys
 * 
...
public class ExplorerPageIntegrationTest extends AbstractIntegrationTest {
	...
	public void testTablePage() {
		...
		WebElement resultTable = browser.findElement(By
	...
	public void testFrenchPageEncoding() {
		...
		WebElement search_h3 = browser
				.findElement(By.cssSelector("#search h3"));
	...
	public void testCookie() {
		...
		WebElement toggle_scientific = browser.findElement(By
				.id("toggle-col-0"));
		toggle_scientific.click();

		List<WebElement> column_headers = browser.findElements(By
				.cssSelector("table#results thead tr th"));
		assertFalse(column_headers.get(0).isDisplayed());

		browser.navigate().refresh();

		List<WebElement> column_headers_refreshed = browser.findElements(By
				.cssSelector("table#results thead tr th"));
