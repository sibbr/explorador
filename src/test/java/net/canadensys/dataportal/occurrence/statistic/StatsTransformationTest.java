...
public class StatsTransformationTest {
	...
	public void testStatsTransformationDecade() {
		...
		Map<String, Integer> formatedData = StatsTransformation
				.transformDecadeData(decadeData,
						ResourceBundle.getBundle("ApplicationResources"));

		// First element shall be sum of counts before 1850
		assertEquals(new Integer(2), formatedData.entrySet().iterator().next()
				.getValue());
	...
	public void testStatsTransformationAltitude() {
		...
		Map<String, Integer> formatedData = StatsTransformation
				.transformAltitudeData(altitudeData,
						ResourceBundle.getBundle("ApplicationResources"));
