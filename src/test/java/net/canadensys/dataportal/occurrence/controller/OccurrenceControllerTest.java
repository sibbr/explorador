...
public class OccurrenceControllerTest extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void setup() {
		...
		jdbcTemplate
				.update("INSERT INTO occurrence_raw (auto_id,dwcaId,country,locality,datasetname,sourcefileid) VALUES (1,'2','Mexico','Mexico','University of Mexico (UOM)','uom-occurrence')");
		jdbcTemplate
				.update("INSERT INTO occurrence_raw (auto_id,dwcaId,country,locality,datasetname,sourcefileid) VALUES (2,'2.2','Mexico','Mexico','University of Mexico (UOM)','uom-occurrence')");
		jdbcTemplate
				.update("INSERT INTO occurrence (auto_id,dwcaId,country,locality,datasetname,sourcefileid,syear,smonth,sday) VALUES (1,'2','Mexico','Mexico','University of Mexico (UOM)','uom-occurrence',2001,03,21)");
		jdbcTemplate
				.update("INSERT INTO occurrence (auto_id,dwcaId,country,locality,datasetname,sourcefileid,syear,smonth,sday) VALUES (2,'2.2','Mexico','Mexico','University of Mexico (UOM)','uom-occurrence',2001,03,21)");
