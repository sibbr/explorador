...
public class AutoCompleteServiceImpl implements AutoCompleteService {
	...
	/**
	 * Search for auto-completion. This implementation will sanitized the
	 * currValue for the comparison
	 * 
	 * @param field
	 * @param currValue
	...
	public String search(String field, String currValue) {
		if (currValue != null) {
			return occDAO.getSuggestionsFor(field,
					StringUtils.unaccent(currValue.toLowerCase()), true);
		}
	...
	public Collection<UniqueValuesModel> getAllPossibleValues(String field) {
		List<UniqueValuesModel> possibleValues = occDAO
				.getAllPossibleValues(field);
		Map<String, UniqueValuesModel> sortedPossibleValues = new TreeMap<String, UniqueValuesModel>(
				new UnaccentStringComparator());
