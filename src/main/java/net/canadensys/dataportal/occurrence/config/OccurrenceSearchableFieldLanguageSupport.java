...
/**
 * This class contains configurations related to the language support on client
 * side.
 * 
 * @author canadensys
 * 
...
public class OccurrenceSearchableFieldLanguageSupport {
	...
	/**
	 * This is used for dynamic components on client-side. It doesn't contain
	 * all the language resources.
	 * 
	 * @param locale
	 * @return
	 */
	public Map<String, String> buildLanguageResourcesMap(
		...
		while (rbKeys.hasMoreElements()) {
			...
			if (shouldInclude(currKey)) {
				languageResources.put(currKey,
						resourceBundle.getString(currKey));
			}
		}
	...
	/**
	 * URL resource bundle are inverted bundle in the form of
	 * translatedValue=key
	 * 
	 * @param resourceBundle
	 * @return
	 */
	public Map<String, String> buildURLLanguageResourcesMap(
			ResourceBundle resourceBundle) {
		Map<String, String> languageResources = new HashMap<String, String>();
		...
		while (keys.hasMoreElements()) {
			...
			languageResources.put(
					URL_PREFIX + resourceBundle.getString(translatedValue),
					translatedValue);
		}
		return languageResources;
	}
	...
	/**
	 * Check if we should include this languageResource based on the
	 * PREFIX_FILTER_LIST.
	 * 
	 * @param languageResource
	 * @return true if languageResource starts with a prefix in
	 *         PREFIX_FILTER_LIST, otherwise, false.
	 */
