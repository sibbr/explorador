...
/**
 * Controller to check the status of the web application. This controller will
 * answer to HEAD and GET queries. This is often used by external service like
 * UptimeRobot.
 * 
 * @author canadensys
 * 
...
public class HealthController {
	...
	/**
	 * Response to HEAD request with a HTTP_OK and no content, as defined by the
	 * standard.
	 * 
	 * @param response
	 */
	...
	public void healthCheckGet(HttpServletResponse response) {
		try {
			...
			response.getWriter().println(
					"Version : " + appConfig.getCurrentVersion());
