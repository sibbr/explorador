...
public class ControllerHelper {
	 ...
	 * @param modelRoot
	 */
	public static void setOccurrenceVariables(HttpServletRequest request, String resourceName, String resourceParam, OccurrencePortalConfig appConfig, HashMap<String,Object> modelRoot){
		//Are we using versioning?
		if(!StringUtils.isBlank(appConfig.getCurrentVersion())){
			modelRoot.put("currentVersion", appConfig.getCurrentVersion());
		}
