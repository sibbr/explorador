...
public class ControllerHelper {
	 ...
	 * @param modelRoot
	 */
	public static void setPageHeaderVariables(HttpServletRequest request,
			String resourceName, String[] resourceParams,
	 ...
	 * @param modelRoot
	 */
	public static void setOccurrenceVariables(HttpServletRequest request,
	...
	/**
	 * Add common header variables to modelRoot to the dataset view. Including
	 ...
	 * @param modelRoot
	 */
	public static void setDatasetVariables(HttpServletRequest request,
			String resourceName, String resourceParam,
			OccurrencePortalConfig appConfig, HashMap<String, Object> modelRoot) {
		// Are we using versioning?
		if (!StringUtils.isBlank(appConfig.getCurrentVersion())) {
