...
/**
 * CacheInvalidation strategy using Spring @Scheduled and ImportLogDAO. At a
 * fixed rate, we get the timestamp of the last import log and purge the cache
 * if needed.
 * 
 * @author cgendreau
 * 
...
public class CacheInvalidationScheduled implements CacheInvalidationStrategyIF {
	...
	private static final Logger LOGGER = Logger
			.getLogger(CacheInvalidationScheduled.class);
	...
	public void checkCacheState() {
		...
		long lastImportTimestamp = lastImport.getEvent_end_date_time()
				.getTime();
