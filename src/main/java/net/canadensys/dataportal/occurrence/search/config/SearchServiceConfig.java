...
public class SearchServiceConfig {
	...
	public enum SearchableFieldGroupEnum {
		CLASSIFICATION(SearchableFieldEnum.KINGDOM, SearchableFieldEnum.PHYLUM, SearchableFieldEnum.CLASS, SearchableFieldEnum.ORDER,
				SearchableFieldEnum.FAMILY, SearchableFieldEnum.GENUS, SearchableFieldEnum.SCIENTIFIC_NAME), LOCATION(SearchableFieldEnum.CONTINENT,
				SearchableFieldEnum.COUNTRY, SearchableFieldEnum.STATE_PROVINCE, SearchableFieldEnum.COUNTY, SearchableFieldEnum.MUNICIPALITY), DATE(
				SearchableFieldEnum.DECADE), ALTITUDE(SearchableFieldEnum.AVERAGE_ALTITUDE_ROUNDED);
	...
	public SearchServiceConfig() {
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.COUNTRY.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.COUNTRY.id, "country")
				.singleValue("country", String.class).eqOperator().likeOperator(QueryOperatorEnum.CLIKE).supportSuggestion().eqOperator()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.FAMILY.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.FAMILY.id, "family")
				.singleValue("family", String.class).eqOperator().likeOperator(QueryOperatorEnum.CLIKE).supportSuggestion().eqOperator()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.CONTINENT.id,
				new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.CONTINENT.id, "continent").singleValue("continent", String.class)
						.eqOperator().likeOperator(QueryOperatorEnum.SLIKE).supportSuggestion().eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.TAXONRANK.id,
				new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.TAXONRANK.id, "taxonrank").singleValue("taxonrank", String.class)
						.eqOperator().likeOperator(QueryOperatorEnum.CLIKE).supportSuggestion().eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.DATE_RANGE.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.DATE_RANGE.id,
				"daterange").startEndDate(START_YEAR_PROPERTY, START_MONTH_PROPERTY, START_DAY_PROPERTY).eqOperator().betweenOperator()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.START_YEAR.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.START_YEAR.id, "syear")
				.singleValue("syear", Integer.class).eqOperator().betweenOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.CATALOG_NUMBER.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.CATALOG_NUMBER.id,
		...
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.ALTITUDE_RANGE.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.ALTITUDE_RANGE.id,
				"altituderange").minMaxNumber("minimumelevationinmeters", "maximumelevationinmeters", Double.class).eqOperator().betweenOperator()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.LOCALITY.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.LOCALITY.id, "locality")
				.singleValue("locality", String.class).likeOperator(QueryOperatorEnum.CLIKE).toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.RECORDED_BY.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.RECORDED_BY.id,
				"recordedby").singleValue("recordedby", String.class).likeOperator(QueryOperatorEnum.CLIKE).eqOperator().supportSuggestion()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.RECORD_NUMBER.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.RECORD_NUMBER.id,
				"recordnumber").singleValue("recordnumber", String.class).likeOperator(QueryOperatorEnum.ELIKE).toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.KINGDOM.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.KINGDOM.id, "kingdom")
				.singleValue("kingdom", String.class).eqOperator().supportSuggestion().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.ORDER.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.ORDER.id, "_order")
				.singleValue("_order", String.class).eqOperator().likeOperator(QueryOperatorEnum.CLIKE).eqOperator().supportSuggestion()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.SCIENTIFIC_NAME.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.SCIENTIFIC_NAME.id,
				"scientificname").singleValue("scientificname", String.class).eqOperator().likeOperator(QueryOperatorEnum.SLIKE).supportSuggestion()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.INSTITUTION_CODE.id, new OccurrenceSearchableFieldBuilder(
				SearchableFieldEnum.INSTITUTION_CODE.id, "institutioncode").singleValue("institutioncode", String.class).eqOperator()
				.supportSelectionList().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.CLASS.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.CLASS.id, "_class")
				.singleValue("_class", String.class).eqOperator().likeOperator(QueryOperatorEnum.CLIKE).eqOperator().supportSuggestion()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.PHYLUM.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.PHYLUM.id, "phylum")
				.singleValue("phylum", String.class).eqOperator().likeOperator(QueryOperatorEnum.CLIKE).eqOperator().supportSuggestion()
				.toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.HAS_COORDINATES.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.HAS_COORDINATES.id,
				"hascoordinates").singleValue("hascoordinates", Boolean.class).eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.HAS_MEDIA.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.HAS_MEDIA.id, "hasmedia")
				.singleValue("hasmedia", Boolean.class).eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.HAS_TYPE_STATUS.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.HAS_TYPE_STATUS.id,
				"hastypestatus").singleValue("hastypestatus", Boolean.class).eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.COUNTY.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.COUNTY.id, "county")
				.singleValue("county", String.class).eqOperator().supportSuggestion().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.MUNICIPALITY.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.MUNICIPALITY.id,
				"municipality").singleValue("municipality", String.class).eqOperator().likeOperator(QueryOperatorEnum.CLIKE).eqOperator()
		...
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.GEO_POLYGON.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.GEO_POLYGON.id,
				"geopolygon").insidePolygon("the_geom", "the_shifted_geom").inOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.GEO_ELLIPSE.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.GEO_ELLIPSE.id,
				"geoellipse").withinRadius("the_geom").inOperator().toOccurrenceSearchableField());

		// Those searchable fields are used for stats only
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.GENUS.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.GENUS.id, "genus")
				.singleValue("genus", String.class).eqOperator().likeOperator(QueryOperatorEnum.CLIKE).eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.SPECIES.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.SPECIES.id, "species")
				.singleValue("species", String.class).eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.DECADE.id, new OccurrenceSearchableFieldBuilder(SearchableFieldEnum.DECADE.id, "decade")
				.singleValue("decade", Integer.class).eqOperator().toOccurrenceSearchableField());
		SEARCHABLE_FIELD_MAP.put(SearchableFieldEnum.AVERAGE_ALTITUDE_ROUNDED.id, new OccurrenceSearchableFieldBuilder(
				SearchableFieldEnum.AVERAGE_ALTITUDE_ROUNDED.id, "averagealtituderounded").singleValue("averagealtituderounded", Integer.class)
				.eqOperator().toOccurrenceSearchableField());
