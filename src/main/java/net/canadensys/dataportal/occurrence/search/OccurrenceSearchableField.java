...
public class OccurrenceSearchableField implements SearchableField {
	...
	public OccurrenceSearchableField(OccurrenceSearchableField toCopy) {
		...
		if (toCopy.supportedOperator != null) {
			this.supportedOperator = new ArrayList<QueryOperatorEnum>(
					toCopy.supportedOperator);
		}
	...
	@Override
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(searchableFieldId)
				.append(searchableFieldName).append(type)
				.append(searchableFieldTypeEnum).append(supportSuggestion)
				.append(supportPartialMatch).append(supportSelectionList)
				.append(supportedOperator).append(relatedFields)
	...
	public void setSearchableFieldTypeEnum(
			SearchableFieldTypeEnum searchableFieldTypeEnum) {
