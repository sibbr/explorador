...
public class OccurrenceSearchServiceImpl implements OccurrenceSearchService {
	...
	@Override
	@Transactional(readOnly = true)
	public DownloadResultStatus searchAsDwca(Map<String, List<SearchQueryPart>> searchCriteria, String fileName,
	 ...
	 */
	@Override
	public void getResultAsDwcaAsync(final Map<String, List<SearchQueryPart>> searchCriteria, final String fileName,
		...
		taskExecutor.execute(new Runnable() {
			...
			public void run() {
				...
				if (dwcaFile != null && dwcaFile.exists()) {
					...
					templateData.put("institutionCodeList",
							StringEscapeUtils.escapeHtml4(StringUtils.join(dwcaBuilder.getDistinctInstitutionCode(searchCriteria), ", ")));
	 ...
	 *            StatsPropertiesEnum.RESOURCE_BUNDLE, StatsPropertiesEnum.MAX_RESULT
	 * @return
	 */
	@Override
	@Transactional(readOnly = true)
	public ChartModel getValuesFrequencyDistribution(Map<String, List<SearchQueryPart>> searchCriteria, OccurrenceSearchableField column,
	...
	@Override
	@Transactional(readOnly = true)
	public Map<Object, Integer> getValuesFrequencyDistributionAsMap(Map<String, List<SearchQueryPart>> searchCriteria,
			OccurrenceSearchableField column, Map<StatsPropertiesEnum, Object> extraProperties) {
		ResourceBundle resourceBundle = (ResourceBundle) extraProperties.get(StatsPropertiesEnum.RESOURCE_BUNDLE);
		Integer maxResult = (Integer) extraProperties.get(StatsPropertiesEnum.MAX_RESULT);
	 ...
	 * @param column
	 * @param searchCriteria
	 *            will be modified if 'column' is not already in the searchCriteria
	 */
