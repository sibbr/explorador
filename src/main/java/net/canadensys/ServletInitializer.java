...
/**
 * This class contains calls to initialization methods. This class will be
 * called at each deploy of the WebApp
 */
public class ServletInitializer extends HttpServlet {

	// get log4j handler
	private static final Logger LOGGER = Logger
			.getLogger(ServletInitializer.class);
	private static final long serialVersionUID = 800750579657221432L;

	@Override
	public void init() throws ServletException {
		// this method is working fine with the current version of Tomcat (6)
		// but could not be reliable
	...
	/**
	 * Close the C3P0 connections explicitly, it seems to leak. If we don't, we
	 * get this error: The web application [/explorer] appears to have started a
	 * thread named
