...
public class EOLPage {
	 ...
	 */
	public EOLPage(String id, String richnessScore,
			ArrayList<EOLSynonym> syonyms,
			ArrayList<EOLVernacularName> vernacularNames,
			ArrayList<EOLTaxonConcept> taxonConcepts,
			ArrayList<EOLImage> images, ArrayList<EOLText> texts,
			ArrayList<EOLAudio> audio) {
		setId(id);
