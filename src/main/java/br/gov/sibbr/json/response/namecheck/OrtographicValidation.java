...
public class OrtographicValidation implements Serializable {
	 ...
	 * @param sinonimoDe
	 */
	public OrtographicValidation(String classificacaoSuperior,
			String fonteAvaliadora, Boolean isNomeEncontrado,
			Boolean isNomeFornecido, Boolean isSinonimo, String nome,
			String nivelTaxonomico, String sinonimoDe) {
		super();
		this.nome = nome;
		this.fonteAvaliadora = fonteAvaliadora;
		this.isNomeEncontrado = isNomeEncontrado;
