				...
				<div id="filter_select">
					<select id="key_select">
						<optgroup label="${rc.getMessage("filter.group.classification")}">
							...
							<option value="${page.availableFilters.specificepithet}">${rc.getMessage("filter.specificepithet")}</option>
							<option value="${page.availableFilters.infraspecificepithet}">${rc.getMessage("filter.infraspecificepithet")}</option>
