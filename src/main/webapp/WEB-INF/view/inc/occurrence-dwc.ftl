<div id="dwc" target="_blank">
   <h3><i>${rc.getMessage("occpage.heather.desc.dwc")}</i></h3>
   <p>  	<a id="dwc_table_toggle" href="#" target="_blank">${rc.getMessage("occpage.header.toggle.unused")}</a></p>
   <table id="dwc_table" class="sortable" target="_blank">
      <thead>
         <tr>
            <th class="sorttable_numeric" scope="col" target="_blank">${rc.getMessage("occpage.dwctable.order")}</th>
            <th class="sorttable_alpha" scope="col" target="_blank">${rc.getMessage("occpage.dwctable.category")}</th>
            <th class="sorttable_alpha" scope="col" target="_blank">${rc.getMessage("occpage.dwctable.term")}</th>
            <th class="sorttable_alpha" scope="col" target="_blank">${rc.getMessage("occpage.dwctable.raw")}</th>
            <th class="sorttable_alpha" scope="col" target="_blank">${rc.getMessage("occpage.dwctable.interpreted")}</th>
         </tr>
      </thead>
      <tbody>
         <tr>
