...
<body>
	...
	<div style="color: #22241e; font-family: 'Lucida Grande', Arial, Sans-Serif; font-size: 14px; line-height: 1.5em; padding: 18px 36px">
		<p>Los datos que ha solicitado a través de la <a href="http://www.sibbr.gov.br/portal-biodiversidade" style="color: #a82400;">explorador SiBBr </a> on ${requestTimestampText}están ahora disponibles para su descarga:</p>
