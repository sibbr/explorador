...
<body>
	...
	<div style="color: #22241e; font-family: 'Lucida Grande', Arial, Sans-Serif; font-size: 14px; line-height: 1.5em; padding: 18px 36px">
		<p>Olá, caro publicador ${nameto}. O usuário <b>${namefrom}</b> <a href="${mailfrom}">(${mailfrom})</a> enviou-lhe a seguinte mensagem através do nosso portal:</p>
		...
		<p>Por favor, para responder, entre em contato diretamente com ${namefrom} no endereço <a href="${mailfrom}">(${mailfrom})</a>.
