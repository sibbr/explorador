...
<body>
	...
	<div style="color: #22241e; font-family: 'Lucida Grande', Arial, Sans-Serif; font-size: 14px; line-height: 1.5em; padding: 18px 36px">
		<p>The data you requested via the <a href="http://www.sibbr.gov.br/explorador" style="color: #a82400;">SiBBr explorer</a> on ${requestTimestampText} are now available for download:</p>
