...
<body>
	...
	<div style="color: #22241e; font-family: 'Lucida Grande', Arial, Sans-Serif; font-size: 14px; line-height: 1.5em; padding: 18px 36px">
		<p>Hello, dear publisher ${nameto}. User <b>${namefrom}</b> <a href="${mailfrom}">(${mailfrom})</a> has sent you the following message from our portal:</p>
		...
		<p>Please, in order to answer it, contact the user ${namefrom} directly through the address <a href="${mailfrom}">(${mailfrom})</a>.
