...
<body>
	...
	<div style="color: #22241e; font-family: 'Lucida Grande', Arial, Sans-Serif; font-size: 14px; line-height: 1.5em; padding: 18px 36px">
		<p>Les donn&eacute;es que vous avez demand&eacute;es via l'<a href="http://www.sibbr.gov.br/explorador" style="color: #a82400;">explorateur SiBBr</a> le ${requestTimestampText} sont maintenant disponibles pour t&eacute;l&eacute;chargement:</p>
		...
		<p><code>${institutionCodeList}. <a href="http://buriti.lncc.br/explorador" style="color: #a82400;">http://buriti.lncc.br/explorador</a> (visit&eacute; le  ${requestTimestamp?date?iso_utc})</code></p>
