...
<body>
	...
	<div style="color: #22241e; font-family: 'Lucida Grande', Arial, Sans-Serif; font-size: 14px; line-height: 1.5em; padding: 18px 36px">
		<p>Os dados requisitados pelo <a href="http://www.sibbr.gov.br/portal-biodiversidade" style="color: #15c;">Portal de Dados de Biodiversidade</a> do SiBBr ${requestTimestampText}, estão disponíveis para download no link:</p>
		<a href="${dwcaLink}" style="background: #F7F4B2 url('http://buriti.lncc.br/portal-biodiversidade/common/images/button-dwca.png') top right no-repeat; ; border: 1px solid #a8a7a5; border-radius: 5px; color: #15c; display: block; height: 48px; font-size: 15px; line-height: 48px; margin: auto; padding: 0 63px 0 15px; text-decoration: none; width: 150px">Baixar dados DwC-A</a></p>
		...
		<p><code>${institutionCodeList}. <a href="http://buriti.lncc.br/portal-biodiversidade" style="color: #15c;">http://buriti.lncc.br/portal-biodiversidade</a> (acessado em ${requestTimestamp?date?iso_utc})</code></p>
